...
%=======================================================================
	...
	or( [ check( i_user_check( check_margin_exists, LEFT_MARGIN_NAME_STRING ) )
		
		, [ with( LEFT_MARGIN_NAME )
			, check( i_user_check( gen1_store_address_margin( LEFT_MARGIN_NAME ), MARGIN_START, 10, 10 ) )
		]
...
%=======================================================================
i_user_check( check_margin_exists, LEFT_MARGIN_NAME_STRING )
%-----------------------------------------------------------------------
:-
	sys_string_atom( LEFT_MARGIN_NAME_STRING, LEFT_MARGIN_NAME ),
	i_user_data( address_margin( [ LEFT_MARGIN_NAME, _, _, _ ] ) )
.
%=======================================================================
%=======================================================================
